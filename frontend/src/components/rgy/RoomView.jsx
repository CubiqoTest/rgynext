...
const generateMockMessages = (roomName) => [
  {
    id: 1,
    type: "system",
...
export const RoomView = ({ room, color, onBack }) => {
...
// List View Component
const ListViewMessages = ({ messages, formatTime, color }) => (
...
// Card View Component
const CardViewMessages = ({ messages, formatTime, color }) => (
...
// Grid View Component  
const GridViewMessages = ({ messages, formatTime, color }) => (
